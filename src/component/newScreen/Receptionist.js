...
//  })
  return (
    <div id="page">
      ...
      <div id="content" style={{marginTop:8}}>
        <Grid container spacing={2} >
          <Grid item xs={12} md={4}>
            <div className='containMain'>
              <div className="complete">❀ <span style={{fontWeight:500}}>Tư vấn</span> <br/>
                          ...
                          <div className='chillStatus'>
                            ...
                            <div className='itemCheckin' style={{
                              ...
                              fontStyle:'italic'
                                ...
                                Check In: <Moment format="HH:ss">{item.checkInAt}</Moment> 
                            </div>
                          </div>
                        </Grid>
                      </Grid>
          ...
          <Grid item xs={12} md={4}>
            <div className='containMain'>
              <div className="complete">❀ <span style={{fontWeight:500}}>Điều trị</span> <br/> 
              <div className="popup"style={{
                  display: 'flex',
                  paddingLeft: 0,
                  position:'relative'
